import { type Firestore, type CollectionReference, type DocumentSnapshot, FieldPath } from "firebase-admin/firestore"
...
export class LevelDao {
    ...
    protected getCollection(groupId: string): CollectionReference {
    ...
    async search({ groupId }: { groupId: string }) {
        ...
        const collection: CollectionReference = this.getCollection(groupId)
